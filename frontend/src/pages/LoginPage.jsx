...
export default function LoginPage() {
  ...
  const demoCredentials = [
    ...
    { label: 'High Risk', email: 'highrisk@company.com', password: 'password123', role: 'employee' },
    { label: 'Low Risk', email: 'lowrisk@company.com', password: 'password123', role: 'employee' },
    { label: 'Beginner', email: 'beginner@company.com', password: 'password123', role: 'employee' },
  ];
